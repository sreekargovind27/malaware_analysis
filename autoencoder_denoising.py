...
This model adds noise during training to improve robustness and uses pre-optimized hyperparameters.
"""
...
class DenoisingAutoencoder(nn.Module):
    """Denoising Autoencoder with noise injection and a fixed architecture."""
...
class DenoisingAutoencoderModel:
    """Wrapper for the Denoising Autoencoder, handling training and inference."""
    ...
    def save_model(self, filename):
        """Save the model and its associated scaler."""
